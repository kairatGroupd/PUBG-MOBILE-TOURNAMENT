                ...
                <div>
                    ...
                    <div className="desc-reg">
                        ...
                        <ul>
                            ...
                            <li>После отправки регистрационной формы вы получите уведомление по электронной почте от desis1tinfo@gmail.com с доступными способами оплаты.</li>
                            <li>Способы оплаты доступны: О!Деньги, Мбанк, Оптима.</li>
                            <li>После того, как вы успешно произвели платеж, отправьте снимок экрана вместе с идентификатором игрока / тегом игрока, который использовался для регистрации, на desis1tinfo@gmail.com.</li>
                            <li>Крайний срок регистрации – 22 мая 2022 ГОДА.</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div className="prize">
                        ...
                        <div className="prize-info">
                            <ul className="prize-list">
                                <li>За каждый кил ➡ <strong><span>100 сом</span></strong> </li>
